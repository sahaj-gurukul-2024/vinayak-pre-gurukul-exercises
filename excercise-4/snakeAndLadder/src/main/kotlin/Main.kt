fun gamePlayLogic(presentValue:Int,dice:Int,ladders:HashMap<Int,Int>,snakes:HashMap<Int,Int>): Int {
...
fun main(args: Array<String>) {
    ...
    val diceValues:List<Int> = readln().split(" ").map{it.toInt()}
    var presentValue=1
    for(dice in diceValues){
        presentValue=gamePlayLogic(presentValue,dice,ladders,snakes)
    }
